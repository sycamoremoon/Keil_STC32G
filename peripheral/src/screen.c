...
{
	//设置为准双向口
	P0_MODE_IO_PU(GPIO_Pin_5 | GPIO_Pin_7);
	P1_MODE_IO_PU(GPIO_Pin_3);
    P2_MODE_IO_PU(GPIO_Pin_1);		
	P4_MODE_IO_PU(GPIO_Pin_0 | GPIO_Pin_3);
}
...
0x00,0x00,0x3c,0x10,0x10,0x10,0x10,0x10,0x10,0x10,0x10,0x10,0x10,0x3c,0x00,0x00, //"l"
