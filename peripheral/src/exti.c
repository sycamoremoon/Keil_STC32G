...
void Exti_config(void)
{
	...
	NVIC_INT1_Init(ENABLE,Priority_3);		//中断使能, ENABLE/DISABLE; 优先级(低到高) Priority_0,Priority_1,Priority_2,Priority_3

	NVIC_INT2_Init(DISABLE,Priority_0);		//中断使能, ENABLE/DISABLE; 无优先级,只能为最低优先级
	NVIC_INT3_Init(DISABLE,Priority_0);		//中断使能, ENABLE/DISABLE; 无优先级，只能为最低优先级
