...
#define PWMA_Counter(n)					{PWMA_CNTRH = (n>>8); PWMA_CNTRL = (n);}	//计数器设置
#define PWMB_Counter(n)					{PWMB_CNTRH = (n>>8); PWMB_CNTRL = (n);}	//计数器设置
...
#define PWMA_Prescaler(n)				{PWMA_PSCRH = (n>>8); PWMA_PSCRL = (n);}	//预分频器设置
#define PWMB_Prescaler(n)				{PWMB_PSCRH = (n>>8); PWMB_PSCRL = (n);}	//预分频器设置
