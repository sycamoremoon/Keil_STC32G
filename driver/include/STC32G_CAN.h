...
#define	DUAL_FILTER      0     //双滤波
#define	SINGLE_FILTER    1     //单滤波
...
typedef struct
{
	...
	u8	CAN_ListenOnly;					//Listen Only模式   ENABLE,DISABLE
	u8	CAN_Filter;						//滤波选择    DUAL_FILTER(双滤波),SINGLE_FILTER(单滤波)
...
//                              外部声明
//========================================================================
extern bit B_Can1Send;     //CAN1 发送完成标志
extern bit B_Can2Send;     //CAN2 发送完成标志
