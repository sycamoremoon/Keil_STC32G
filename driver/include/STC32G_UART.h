...
#define	COM_RX1_Lenth	128         //设置串口1接收数据缓冲区大小，如果长度定义大于256，需要将程序中与该长度比较的变量类型由u8改为u16.
#endif
#ifdef UART2
#define	COM_TX2_Lenth	128         //设置串口2发送数据缓冲区大小，如果长度定义大于256，需要将程序中与该长度比较的变量类型由u8改为u16.
#define	COM_RX2_Lenth	128         //设置串口2接收数据缓冲区大小，如果长度定义大于256，需要将程序中与该长度比较的变量类型由u8改为u16.
#endif
#ifdef UART3
#define	COM_TX3_Lenth	64          //设置串口3发送数据缓冲区大小，如果长度定义大于256，需要将程序中与该长度比较的变量类型由u8改为u16.
